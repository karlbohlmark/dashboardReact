...
class SegmentMapTask extends React.Component {
    ...
    componentWillMount() {
        // this.props.onChangeTaskStatusHandler(TASK_STATYS_COMPLETED);
        // this.props.onChangeTaskStatusHandler(TASK_STATYS_ASSIGNED);
        // this.props.onChangeTaskStatusHandler(TASK_STATYS_UNASSIGNED);
        // this.props.onChangeTaskStatusHandler(TASK_STATYS_DECLINED);
        // this.props.onChangeTaskStatusHandler(TASK_STATYS_CANCELLED);
    }
    render() {
        return (
