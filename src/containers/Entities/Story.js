    ...
    render() {
        return (
            <Story
                ...
                modalPreviewMediumImageAddHandler={f => this.props.modalPreviewImageAdd(IMAGE_SIZE_MEDIUM, f)}
                ...
                modalPreviewMediumImageHandler={f => this.props.modalPreviewImage(IMAGE_SIZE_MEDIUM, f)}
                ...
                uploadMediumImageHandler={f => this.props.uploadImage(IMAGE_SIZE_MEDIUM, f)}
                ...
                removeMediumImageHandler={() => this.props.removeImage(IMAGE_SIZE_MEDIUM)}
            ...
            errors: [
                ...
                mSubmitErrors.map(submitErrors => ({
                    ...
                    images: {
                        ...
                        medium: get(IMAGE_SIZE_MEDIUM, submitErrors.images),
